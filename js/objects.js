(function() {
    ...
    shoppers.forEach(function(shopper) {
        console.log(shopper.name);
            ...
            if (shopper.amount > 200) {
                ...
                alert(shopper.name + " spent $" + shopper.amount.toFixed(2) + " and will get $" + discountAmount.toFixed(2) + " off.  " + shopper.name + "'s new total is $" + newTotal.toFixed(2));
            } else {
                alert(shopper.name + " spent $" + shopper.amount.toFixed(2) + " and will not receive a discount today.");
            }
    });
    ...
    var books = [
        ...
        {title: "The Alchemist", author: {firstName: "Paulo", lastName: "Coelho"}},
